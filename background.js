...
mysocket = new WebSocket("ws://butwhythough.design:8000/");
...
function handle_click(tab) {
    ...
    // TODO send proper message format here!
...
mysocket.onmessage = function(evt) { 
    ...
    if(data.kind == "auth"){
        ...
        // TODO send username (select by person)
    } else if(data.kind == "tab"){
        console.log('received a tab!')
        // TODO load new tab!
    } else {
        console.log('UH OH, dont know what to do with this message!')
    }
...
browser.commands.onCommand.addListener(function(command) {
  if (command == "open-inbox") {
    console.log("open the inbox!");
  }
});
